...
#   timestamp: 2025-04-14T03:42:09+00:00
...
class Geometry(
    RootModel[
        Union[
            data.PointModel,
            data.LineStringModel,
            data.PolygonModel,
            data.MultiPointModel,
        ]
    ]
):
    root: Union[
        data.PointModel, data.LineStringModel, data.PolygonModel, data.MultiPointModel
    ]
...
class WorldLayer(EidosModel):
    ...
    """
    This layer can only visible on its own
    """
