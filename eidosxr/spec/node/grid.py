...
from .. import theme
from . import derived, document, plot, world
...
class GridLayoutItem(EidosModel):
    ...
    """
    style: Optional[theme.GridStyle] = None
    """
    Custom CSS styles applied to the grid cell wrapper element.
    """
...
class Grid(EidosModel):
    ...
    id: constr(min_length=1) = Field(
        ..., examples=['main-grid', 'dashboard-layout', 'analysis-grid']
    )
    """
    ...
    """
    children: List[Union[world.Nested, plot.Plot, document.Document, derived.Derived]]
    """
