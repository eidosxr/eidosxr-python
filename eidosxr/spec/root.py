...
class EidosSpecification(EidosModel):
    ...
    """
    Visual theme for the whole specification: a color-scheme preset plus optional style overrides for colors, text, controls, panels and grid cells.
    """
    ...
    """
    root: Optional[
        Union[world.World, plot.Plot, document.Document, grid.Grid, menu.Menu]
    ] = None
    """
